...
const LOGO: &[&str] = &[
    r"__        __ ___  _   _   ____  __  __     _     _   _ ",
    r"\ \      / /|_ _|| \ | | / ___||  \/  |   / \   | \ | |",
    r" \ \ /\ / /  | | |  \| || |  _ | |\/| |  / _ \  |  \| |",
    r"  \ V  V /   | | | |\  || |_| || |  | | / ___ \ | |\  |",
    r"   \_/\_/   |___||_| \_| \____||_|  |_|/_/   \_\|_| \_|",
];
    ...
    fn render(self, area: Rect, buf: &mut Buffer) {
        ...
        if area.height < card_h || area.width < card_w {
            ...
            let line = if s.provider.is_empty() {
                "Wingman — no provider configured. Type /help to get started.".to_string()
            } else {
                format!(
                    "Wingman · {}/{} · mode={} · /help for commands",
