...
use anyhow::Result;
use arccode_config::Config;
use arccode_core::{AgentEvent, AgentStop};
use futures::StreamExt;
use std::process::ExitCode;

use crate::runtime::{build_agent, resolve_selection};

pub struct BatchOptions {
    pub file: String,
    pub json: bool,
    pub mode_override: Option<arccode_config::PermissionMode>,
