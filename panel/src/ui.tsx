...
const PATHS = {
  ...
  changes: 'M3.5 7.5h9l-3-3M16.5 12.5h-9l3 3',
  bell: 'M6 8.5a4 4 0 0 1 8 0c0 3 .8 4.3 1.5 5h-11c.7-.7 1.5-2 1.5-5ZM8.4 16a1.8 1.8 0 0 0 3.2 0',
  'bell-off':
    'M7 5.4A4 4 0 0 1 14 8.5c0 1.7.3 2.9.7 3.7M5.6 8.9c-.1 2.4-.8 3.5-1.4 4.1h9M8.4 16a1.8 1.8 0 0 0 3.2 0M3.5 3.5l13 13',
  copy: 'M7.5 7.5h7a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-7a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1ZM4.5 12.5h-1a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h7a1 1 0 0 1 1 1v1',
  check: 'M4.5 10.5 8 14l7.5-8',
  trash: 'M4.5 6h11M8 6V4.5h4V6M5.8 6l.7 10h7l.7-10',
  down: 'M10 4.5v11M5.5 11 10 15.5 14.5 11',
  filter: 'M3.5 5h13l-5 5.7v4.8l-3-1.6v-3.2Z',
} as const
